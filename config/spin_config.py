...
SPIN_REWARDS = [
    {
        ...
        "rewards": {
            "points": 500,
            "items": [{"id": "title_lucky", "name": "🍀 天选之人", "description": "幸运转盘特等奖获得者专属称号"}]
        },
    ...
    },
    {
        ...
        "rewards": {
            "points": 200,
            "items": [{"id": "exp_card", "name": "📚 经验卡", "description": "使用后获得额外20%经验加成"}]
        },
        "message": "🎊 太棒了！你获得了一等奖！"
    },
    {
        ...
        "rewards": {
            "points": 100,
            "items": [{"id": "lottery_ticket", "name": "🎫 抽奖券", "description": "可用于免费抽奖一次"}]
        },
        "message": "✨ 恭喜！你获得了二等奖！"
    },
    {
    ...
    },
    {
        ...
        "rewards": {
            "points": 20,
            "items": [{"id": "fish_bait", "name": "🐟 小鱼干", "description": "钓鱼时恢复20点体力"}]
        },
    ...
    },
    {
        ...
        "rewards": {
            "points": 10,
            "items": [{"id": "comfort_cookie", "name": "🍪 安慰饼干", "description": "甜甜的小饼干，吃了心情会变好"}]
        },
